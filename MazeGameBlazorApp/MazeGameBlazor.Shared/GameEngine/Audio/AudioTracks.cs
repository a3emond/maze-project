namespace MazeGameBlazor.Shared.GameEngine.Audio
{
    public static class AudioTracks
    {
        ...
        // ================================
        public static readonly string[] MusicPlaylist =
        {
            "bright-electronic-loop-251871.mp3",
            "typical-trap-loop-2b-130751.mp3",
            "relaxing-guitar-loop-v8-252351.mp3",
            "relaxing-guitar-loop-v12-268694.mp3",
